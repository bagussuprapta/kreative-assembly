  ...
  return (
    <div className="text-white py-8">
      <div className="flex flex-col pt-3 pb-7 gap-y-6 border-bugbug-150 border-b-2 lg:flex-row lg:gap-x-10">
        ...
        <div className="flex flex-col gap-y-6 sm:flex sm:flex-row sm:gap-x-4 sm:justify-between lg:w-2/3">
      ...
      <div className="flex flex-col gap-y-3 mt-5 text-sm md:flex-row md:justify-between">
