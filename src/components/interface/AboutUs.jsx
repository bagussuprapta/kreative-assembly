function AboutUs() {
  return (
    <div className="flex flex-col gap-y-5 pt-8 pb-2 sm:pb-4 md:flex md:flex-row md:gap-x-20 md:py-10 xl:py-24">
      <div className="order-2 mt-4 place-self-center md:w-1/2 md:order-1">
        <img className="rounded-2xl w-full object-cover" src="AboutUs.jpg" alt="" />
      </div>
      <div className="order-1 justify-between flex flex-col gap-y-5 md:w-1/2 md:order-2">
        <h2 className="text-3xl lg:text-4xl xl:text-5xl xl:leading-tight text-center md:text-left">About US</h2>
