function Hero() {
  return (
    <div className="mt-32 flex flex-col gap-y-5 md:flex md:flex-row">
      <div className=" flex flex-col gap-y-5 md:w-2/3 justify-between">
        <p className="text-sm text-center text-gray-500 md:text-left md:text-lg">AI-powered insect monitoring tools</p>
